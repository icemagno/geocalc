...
public class UnitClass {
	...
	public List<UnitObject> getInstances() {
		List<UnitObject> temp = new ArrayList<UnitObject>( instances );
		return temp;
	}
	...
	public void publish() throws RTIexception {
		log("Published");
		AttributeHandle positionHandle = rtiamb.getAttributeHandle( unitHandle, "Position" );
